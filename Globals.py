...
group_BACKTILES = pygame.sprite.LayeredUpdates()
group_FILLBACKTILES = pygame.sprite.LayeredUpdates()
group_FRONTTILES = pygame.sprite.LayeredUpdates()
group_BACKSPECIAL = pygame.sprite.LayeredUpdates()
